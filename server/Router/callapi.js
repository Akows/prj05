...
router.post("/call", (req, res) => {
    ...
    if (!uuidAPIKey.isAPIKey(apiKey) || !uuidAPIKey.check(apiKey, uuid)) {
        ...
        var options = {
            'method': 'GET',
            'url': 'https://apis.data.go.kr/B552584/UlfptcaAlarmInqireSvc/getUlfptcaAlarmInfo?serviceKey=z7ImRcb%2BDxJrHffyg9qkxVkYQgzL8EyntQLQds6ahlEhx4Jo10F1luSE4gBwkvxI3JWbQqINDilLifoBhUJVDQ%3D%3D&returnType=json&numOfRows=2&pageNo=1&year=2020&itemCode=PM10',
            'headers': {
